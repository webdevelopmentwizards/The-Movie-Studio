...
- **Payment plans (recurring):** $9.99/month OR $89.99/year (auto-renews until canceled)
- Payments are processed securely via Authorize.net (Accept.js + ARB) on the plan step
