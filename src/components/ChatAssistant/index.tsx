    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-amber-500 text-zinc-950 shadow-lg shadow-amber-500/25 transition-transform hover:scale-105 hover:bg-amber-400 sm:bottom-6 sm:right-6 sm:h-14 sm:w-auto sm:gap-2 sm:px-5"
          aria-label="Open chat assistant"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6" aria-hidden>
            <path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.2L4 17.2V4h16v12z" />
          </svg>
          <span className="hidden text-sm font-bold sm:inline">How may I help you?</span>
        </button>
      )}
